...
install_python_deps() {
    ...
    pip3 install --user -r projects/python_api/python_api/requirements.txt
...
main() {
    ...
    echo -e "${GREEN}╚═══════════════════════════════════════════╝${NC}"
    echo ""
    print_message "You can now run './projects/scripts/scripts/launch.sh' to start the bot."
